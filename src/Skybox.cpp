...
void 		Skybox::computeShaders() {
	...
	int success;
	char info_log[512];
    std::string vertex_shader_path = std::string(SRC_PATH) + "/Shaders/skybox_vertex_shader.glsl";
    std::string fragment_shader_path = std::string(SRC_PATH) + "/Shaders/skybox_fragment_shader.glsl";
